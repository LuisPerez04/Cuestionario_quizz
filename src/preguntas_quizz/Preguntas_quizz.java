package preguntas_quizz;

import java.util.Scanner;

public class Preguntas_quizz {
    ...
    public static void banco_preguntas() {
    ...
    public static void respuestas_incisos() {
    ...
    public static void procesos(){
        ...
        for (int i = 0; i < preguntas.length; i++) {
            ...
            System.out.println();
            System.out.print("Escribe el numero correcto: ");
    ...
    public static int contador(){
     ...
     public static void main(String[] args) {
       banco_preguntas();
        ...
        procesos();
        System.out.println(); 
        System.out.println("Obtuviste " + contadores + " de 10 de calificacion");      
}  
    }
